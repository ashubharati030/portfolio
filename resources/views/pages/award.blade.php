...
@section('content')
<br><br><br><br>
	<div style="margin-left:30px;margin-right:500px;background:rgb(201, 144, 59)" class="row col-md-6 col-sm-6 col-xs-6 jumbotron float-left"> <!--Jumbotron controls the size of card by its margin-->
